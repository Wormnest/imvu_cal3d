...
class Vertex:
	...
	def __init__(self, submesh, index, loc, normal, vertex_color, use_vertex_colors):
		...
		# jgb Whether we need to write vertex colors or not:
	...
	def to_cal3d_xml(self):
		...
		# Only write vertex colors if necessary
